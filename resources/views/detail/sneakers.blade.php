                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div id="carouselExample" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="{{ asset('/storage/posts/' . $sneaker->image) }}" class="rounded mx-auto d-block " alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ asset('/storage/posts/' . $sneaker->foto_depan) }}" class="rounded mx-auto d-block " alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ asset('/storage/posts/' . $sneaker->foto_belakang) }}" class="rounded mx-auto d-block " alt="...">
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 deskripsi">
                                <h4 style="color: #333; font-weight: bold;">{{ $sneaker->nama_produk }}</h4>
                                ...
                                <table class="table1">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td style="color: #333; font-weight: bold;">{{ $sneaker->harga }}</td>
                                        </tr>
                                        <tr>
                                            <td style="color: #666;">Stok</td>
                                            <td></td>
                                            <td style="color: #333; font-weight: bold;">{{ $sneaker->stok }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                                <center>
                                    <form action="{{ route('pesan.pesan', $sneaker->id) }}" method="POST">
                                        @csrf
